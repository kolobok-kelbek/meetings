package com.meetings.configuration;
...
public final class SecurityConstants {
  ...
  public static final String COOKIE_PERMISSIONS_PATH = "/";
  public static final String COOKIE_PERMISSIONS_DOMAIN = "meetings.local";
